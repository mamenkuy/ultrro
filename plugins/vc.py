...
from pyUltroid import CMD_HANDLER as cmd
from pyUltroid import CMD_HELP, call_py
from pyUltroid.events import register
from pyUltroid.utils import edit_delete, edit_or_reply, man_cmd
...
@ultroid_cmd(pattern="startvc$", group_only=True)
...
@ultroid_cmd(pattern="stopvc$", group_only=True)
...
@ultroid_cmd(pattern="vcinvite", group_only=True)
async def _(c):
...
@ultroid_cmd(pattern="vctitle(?: |$)(.*)", group_only=True)
